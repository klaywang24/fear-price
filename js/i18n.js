...
(function () {
  ...
  const D = {
    ...
    "NAAIM 会员主动管理人的平均股票敞口：0 = 空仓，100 = 满仓，大于 100 = 加杠杆；历史底部常见 20 以下 · 尾标为最新读数 · 底部滑块可拖拽缩放。NAAIM 自 2026 年 8 月起改为订阅制，公开数据延迟三个月，本图停在 2026 年 7 月 29 日。": ["Average equity exposure of NAAIM member active managers: 0 = all cash, 100 = fully invested, above 100 = levered; historic bottoms often print below 20 · end label = latest reading · drag the bottom slider to zoom. NAAIM moved to a subscription model in August 2026 with public data delayed three months; this chart stops at 2026-07-29.", "", "", ""],
    ...
    "NAAIM 2026-08 起改订阅制，公开数据延迟三个月，本图停更": ["NAAIM went subscription-only in 2026-08 with public data delayed three months; this chart is no longer updated", "", "", ""],
  ...
  const P = [
    ...
    [/^数据截至 (.+) · (.+) · NAAIM 2026-08 起改订阅制，公开数据延迟三个月，本图停更$/,
      ["Data as of $1 · $2 · NAAIM went subscription-only in 2026-08 with public data delayed three months; chart no longer updated", "", "", ""]],
    [/^数据截至 (.+) · (.+) · 每周六自动更新$/,
