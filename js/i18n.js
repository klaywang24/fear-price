...
(function () {
  ...
  const D = {
    ...
    "纳指波动溢价": ["Nasdaq volatility premium", "", "", ""],
    "当前 VXN": ["VXN now", "", "", ""],
    ...
    // ---- 2026-09-15 仓位与杠杆四件 + 指数波动率家族（Klay 令免费源全接入）----
    "标普 500 期货持仓：杠杆基金与资管机构的净头寸（2010 年至今 · 周频）": ["S&P 500 futures positioning: net positions of leveraged funds and asset managers (2010–present, weekly)", "", "", ""],
    "CFTC 交易者分类报告，标普 500 期货大合约与 E-mini 合并。杠杆基金在股指期货上长期净空，大头是基差交易与对冲，不等于看空；看的是它在自己历史里的位置和转向，不是正负号。周二数据周五发布。": ["CFTC Traders in Financial Futures, S&P 500 full-size and E-mini contracts combined. Leveraged funds are persistently net short index futures, mostly basis trades and hedges, which is not a bearish view; read the position within its own history and its turns, not the sign. Tuesday data published Friday.", "", "", ""],
    "融资余额：客户借券商的钱买股票（1997 年至今 · 月频）": ["Margin debt: money customers borrow from brokers to buy stocks (1997–present, monthly)", "", "", ""],
    "FINRA 会员经纪商客户保证金账户余额，单位十亿美元。实线为融资余额，虚线为融资余额减去两项闲置资金后的净额。融资余额随市值一起涨，创新高不等于杠杆创新高，看同比和净额。参考月次月第三周发布。": ["Customer margin account balances at FINRA member brokers, in billions of dollars. Solid line is debit balances; dashed line is debit balances net of the two free-credit items. Margin debt rises with market value, so a record high is not a record in leverage; read the year-over-year change and the net figure. Published the third week of the following month.", "", "", ""],
    "对冲基金杠杆率：总资产除以净资产（2013 年至今 · 季频）": ["Hedge fund leverage: gross assets over net assets (2013–present, quarterly)", "", "", ""],
    "美国财政部金融研究办公室汇总的 SEC Form PF 数据，只含合格对冲基金。实线为股票策略基金按总资产加权的杠杆率，虚线为全部合格基金的总资产除以净资产。季频，滞后约两个季度。": ["SEC Form PF aggregates compiled by the Treasury's Office of Financial Research, qualifying hedge funds only. Solid line is the gross-asset-weighted leverage ratio of equity strategy funds; dashed line is gross over net assets for all qualifying funds. Quarterly, with roughly a two-quarter lag.", "", "", ""],
    "指数波动率家族 · 30 天隐含波动率在过去 3 年的位置": ["Index volatility family · 30-day implied volatility within the past 3 years", "", "", ""],
    "Cboe 官方指数：标普 500、纳斯达克 100、罗素 2000、道琼斯、20 年以上国债 ETF，以及 VIX 自己的波动率。同一把尺，各自跟自己的历史比。括号内为当日收盘值。": ["Official Cboe indices: S&P 500, Nasdaq 100, Russell 2000, Dow Jones, the 20+ year Treasury ETF, and the volatility of VIX itself. One ruler, each measured against its own history. Closing value in brackets.", "", "", ""],
    "融资余额": ["Margin debt", "", "", ""], "净融资": ["Net margin", "", "", ""], "十亿美元": ["USD bn", "", "", ""],
    "股票策略杠杆率": ["Equity strategy leverage", "", "", ""], "全部合格基金": ["All qualifying funds", "", "", ""],
    "纳斯达克 100": ["Nasdaq 100", "Nasdaq 100", "Nasdaq 100", "Nasdaq 100"], "20 年以上国债 ETF": ["20+ year Treasury ETF", "", "", ""],
    "VIX 的波动率": ["Volatility of VIX", "", "", ""],
    "周二数据周五 15:30 ET 发布，每周更新": ["Tuesday data published Friday 15:30 ET, updated weekly", "", "", ""],
    "月频，参考月次月第三周发布": ["Monthly, published the third week of the following month", "", "", ""],
    "季频，滞后约两个季度": ["Quarterly, about a two-quarter lag", "", "", ""],
    ...
    "买入之后，持有多久": ["After You Buy, How Long You Hold", "Après l'achat, combien de temps garder", "Nach dem Kauf: wie lange halten", "Después de comprar, cuánto mantener"],
    "五年十年二十年": ["Five, Ten, Twenty Years", "Cinq, dix, vingt ans", "Fünf, zehn, zwanzig Jahre", "Cinco, diez, veinte años"],
    "牛熊交替": ["Bull and Bear, Taking Turns", "Haussier et baissier, à tour de rôle", "Bulle und Bär im Wechsel", "Alcista y bajista, por turnos"],
    "最坏的那些日子": ["The Worst Days", "Les pires jours", "Die schlimmsten Tage", "Los peores días"],
    "历次回撤": ["Every Drawdown", "Chaque repli", "Jeder Drawdown", "Cada caída"],
    ...
    "综指五十年": ["Fifty Years of the Composite", "Cinquante ans du Composite", "Fünfzig Jahre Composite", "Cincuenta años del Composite"],
    "纳指历次回撤": ["Every Nasdaq Drawdown", "Chaque repli du Nasdaq", "Jeder Nasdaq-Drawdown", "Cada caída del Nasdaq"],
    "纳指的怕，单独标价": ["The Nasdaq's Fear, Priced Separately", "La peur du Nasdaq, cotée à part", "Die Nasdaq-Angst, separat bepreist", "El miedo del Nasdaq, cotizado aparte"],
    "纳指一百家逐个看": ["The Nasdaq Hundred, One by One", "Les cent du Nasdaq, une à une", "Die Nasdaq-Hundert, einzeln", "Los cien del Nasdaq, uno a uno"],
    ...
    "年度回报分桶": ["Annual returns, bucketed", "Rendements annuels par tranche", "Jahresrenditen nach Klassen", "Rendimientos anuales por tramos"],
    ...
    "所有投资者手里，股票占「股票+债务」的比例：越高，全社会越把钱压在股票上。数据来自美联储资金流量表（Z.1）。这是上面 CFTC 股指期货持仓的慢镜头：一个是杠杆基金和资管机构这周在期货上的站位，一个是整个社会几十年的配置。只报位置、不测方向。": ["Across all investors, the share of equities within equities+debt: the higher it is, the more of society's money sits in stocks. Data from the Federal Reserve Flow of Funds (Z.1). This is the CFTC equity-futures positioning above in slow motion: one is where leveraged funds and asset managers stand in futures this week, the other is society's allocation across decades. Position only, no direction called.", "", "", ""],
    ...
    "单日涨跌的分布（对数计数）": ["Daily return distribution (log count)", "Distribution des rendements quotidiens (log)", "Tagesrenditeverteilung (log)", "Distribución de rendimientos diarios (log)"],
  ...
  const P = [
    ...
    // 2026-07-19 四层扫描抓到的存量泄漏：年度回报分桶图与持有期图的 tooltip 函数体
    ...
    [/^数据截至 (.+)（结算日） · (.+) · 每月两次结算，结算日后约 8 个交易日发布$/,
      ["Data as of $1 (settlement date) · $2 · settled twice monthly, published ~8 trading days after settlement",
       "", "", ""]],
    // 2026-09-15 仓位与杠杆四件：频率句各不相同，四句逐条译
    [/^数据截至 (.+) · (.+) · 周二数据周五 15:30 ET 发布，每周更新$/,
      ["Data as of $1 · $2 · Tuesday data published Friday 15:30 ET, weekly", "", "", ""]],
    [/^数据截至 (.+) · (.+) · 月频，参考月次月第三周发布$/,
      ["Data as of $1 · $2 · monthly, published the third week of the following month", "", "", ""]],
    [/^数据截至 (.+) · (.+) · 季频，滞后约两个季度$/,
      ["Data as of $1 · $2 · quarterly, about a two-quarter lag", "", "", ""]],
    [/^数据截至 (.+) · (.+) · 每周六自动更新$/,
    ...
    [/^· 数据源：.+$/, ["· Data: Yahoo Finance / CNN Fear & Greed / multpl / FRED / SEC EDGAR / Wikipedia · Personal research only — not investment advice",
      "· Données : Yahoo Finance / CNN / multpl / FRED / SEC EDGAR / Wikipedia · Recherche personnelle — pas un conseil en investissement",
      "· Daten: Yahoo Finance / CNN / multpl / FRED / SEC EDGAR / Wikipedia · Private Recherche — keine Anlageberatung",
      "· Datos: Yahoo Finance / CNN / multpl / FRED / SEC EDGAR / Wikipedia · Investigación personal; no es asesoramiento"]],
